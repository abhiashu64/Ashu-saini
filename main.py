...
photologo = 'https://graph.org/file/2a5cb7bb0144ccfda3d37-60007d94009e55415f.jpg'
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/IFSASHU1BOT"),
...
async def txt_handler(bot: Client, m: Message):
    ...
    await m.reply_text("<pre><code>Downloaded By ⌈✨『 ༄࿐𑁍IFS𑁍(आशु)❥◉🇮🇳™』✨⌋</code></pre>")
...
async def txt_handler(bot: Client, m: Message):
    ...
    try: 
        ...
        await m.reply_text(e)
    await m.reply_text("<pre><code>Converted By ⌈✨『 ༄࿐𑁍IFS𑁍(आशु)❥◉🇮🇳™』✨⌋</code></pre>")
